...
*/
const TOKEN = 'pk.eyJ1IjoiYW5hZ2hhdW1lc2giLCJhIjoiY2sxbHo3Y2tqMGF3ajNjbW5hMHA2czNkOCJ9.rGjB8xiZn99uzktovI2cxg';
var locations = [];
...
$(".coordinates").each(function () {
    ...
    var mail = $(".email", this).text().trim();
    var phone = $(".phone", this).text().trim();

    var contact = mail ? "<div>" + mail + "</div>" : "";
    contact += phone ? "<div>" + phone + "</div>" : "";

    // Create a point data structure to hold the values.
    var point = {
        "latitude": latitude,
        "longitude": longitude,
        "description": "<h4>" + name + "</h4><div>" + description + "</div>" + contact
    };
